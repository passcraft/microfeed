          ...
          {bundle && (
            <div className="text-helper-color grid grid-cols-1 gap-4 text-sm">
              <div
                ...
                dangerouslySetInnerHTML={{ __html: bundle.text }}
              />
              {bundle.rss ? (
                <div>
                  <div>
                ...
                <em>{bundle.linkName} is not in rss feed</em>
              )}
              {bundle.json ? (
                <div>
                  <div>
                  ...
                  <div className="text-xs mt-2 text-muted-color">
                    ...
                    . See the OpenAPI spec of yaar's JSON feed:{" "}
                    <a
                      className="text-helper-color"
                ...
                <em>{bundle.linkName} is not in json feed</em>
              )}
            </div>
          )}
        </div>
