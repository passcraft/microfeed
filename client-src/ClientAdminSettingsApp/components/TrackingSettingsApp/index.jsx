...
export default class TrackingSettingsApp extends React.Component {
  ...
  render() {
    ...
    const urls =
      trackingUrls.trim() !== "" ? trackingUrls.trim().split(/\n/) : [];
    ...
    return (
      ...
      >
        ...
        <div className="mt-4 text-xs text-helper-color">
          yaar will automatically add 3rd-party tracking urls (e.g.,{" "}
          <a href="https://op3.dev/">OP3</a>,{" "}
          <a href="http://analytics.podtrac.com/">Podtrac</a>,{" "}
          <a href="https://chartable.com/">Chartable</a>...) before the url of a
          media file, so you can easily track download stats. This is a{" "}
          <a
            href="https://lowerstreet.co/blog/podcast-tracking"
            target="_blank"
            rel="noopener noreferrer"
          >
            common practice in the podcast industry
          </a>
          .
        </div>
        {urls.length > 0 && (
          <div className="mt-4 text-xs break-all text-helper-color">
            <div className="mb-2">
              Example: if an audio url is {exampleAudio}, then the final url in
